...
def _populate_query_params(
    ...
    for name in param_fields:
        ...
        value, global_found = _populate_from_globals(name, value, QueryParamMetadata, gbls)
        if global_found:
        ...
        if serialization is not None:
            serialized_parms = _get_serialized_params(metadata, f_name, value, param_field_types[name])
            ...
            if style == "deepObject":
                ...
                _populate_delimited_query_params(metadata, f_name, value, ",", query_param_values)
