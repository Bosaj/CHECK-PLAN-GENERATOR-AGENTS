...
def _parse_event(raw: bytearray, decoder: Callable[[str], T], sentinel: str | None = None) -> tuple[T | None, bool]:
    block = raw.decode()
    lines = re.split(r"\r?\n|\r", block)
    publish = False
    event = ServerEvent()
    ...
    if data:
        ...
        data_is_primitive = data.isnumeric() or data == "true" or data == "false" or data == "null"
        data_is_json = data.startswith("{") or data.startswith("[") or data.startswith('"')
