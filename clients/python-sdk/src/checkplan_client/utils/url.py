...
def generate_url(
    ...
    globals_already_populated = _populate_path_params(path_params, gbls, path_param_values, [])
    if _is_set(gbls):
...
def _populate_path_params(
    ...
    for name in path_param_fields:
        ...
        if serialization is not None:
            serialized_params = _get_serialized_params(param_metadata, f_name, param, path_param_field_types[name])
