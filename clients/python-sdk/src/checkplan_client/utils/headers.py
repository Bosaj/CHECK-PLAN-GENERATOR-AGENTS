...
def get_headers(headers_params: Any, gbls: Any | None = None) -> dict[str, str]:
...
def _populate_headers(
    ...
    for name in param_fields:
        ...
        value, global_found = _populate_from_globals(name, getattr(headers_params, name), HeaderMetadata, gbls)
        if global_found:
