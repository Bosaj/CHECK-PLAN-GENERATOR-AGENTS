...
from checkplan_client import errors, utils
from checkplan_client._hooks import (
    AfterErrorContext,
    AfterSuccessContext,
    BeforeRequestContext,
)
from checkplan_client.utils import RetryConfig, SerializedRequestBody, get_body_content
...
class BaseSDK:
    ...
    def _build_request_async(
        ...
        get_serialized_body: Callable[[], SerializedRequestBody | None] | None = None,
    ...
    def _build_request_with_client(
        ...
        if serialized_request_body.media_type is not None and serialized_request_body.media_type not in (
            "multipart/form-data",
            "multipart/mixed",
        ):
    ...
    def do_request(
        ...
        error_status_codes,
        stream=False,
        retry_config: tuple[RetryConfig, list[str]] | None = None,
    ) -> httpx.Response:
        client = self.sdk_configuration.client
    ...
    async def do_request_async(
        ...
        if retry_config is not None:
            http_res = await utils.retry_async(do, utils.Retries(retry_config[0], retry_config[1]))
        else:
            http_res = await do()
