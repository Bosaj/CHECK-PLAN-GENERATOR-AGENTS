# Monitoring, Controlling, Evaluation & QA Guide: CHECK-PLAN-GENERATOR-AGENTS

This document describes the standardized Observability, Health Control, Performance Evaluation, and Quality Assurance (QA) architecture for **CHECK-PLAN-GENERATOR-AGENTS**.
